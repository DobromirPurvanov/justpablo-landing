...
const pillars = [
  {
    number: '01',
    title: 'Платформата',
    text: 'Мрежа от профилирани страници с отчетлив хумор — най-много последователи и най-диверсифицираните органично изградени аудитории сред инфлуенсър платформите in България, изграждани от 2013 г. насам.',
  },
  {
    number: '02',
