...
export default function LandingNav() {
  return (
    <>
      ...
      >
        <img src="./images/logo-mark.png" alt="" className="w-10 h-10 lg:w-11 lg:h-11 object-contain" />
      ...
      <button
        ...
        className="fixed top-5 right-5 lg:right-8 z-50 inline-flex items-center gap-2 bg-[#DC2626] text-white text-[11px] uppercase tracking-[0.14em] font-medium px-5 py-3 rounded-full shadow-lg shadow-[#DC2626]/25 hover:bg-[#B91C1C] hover:scale-[1.03] transition-all duration-300"
      >
        Запитване
