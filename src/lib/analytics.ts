/* ────────────────────────────────────────────────────────────
   ...
   Скриптът се инжектира от src/lib/consent.ts; тук само изпращаме събития.
   Ако gtag липсва (блокер, още незареден скрипт), извикванията
   мълчат — трекингът никога не бива да чупи формата.

   Параметърът `page_city` (sofia / varna / plovdiv / burgas / general)
   се закача автоматично за всяко събитие през `gtag('set', …)` в
   consent.ts — не го подавайте ръчно тук.
   ──────────────────────────────────────────────────────────── */
